<template>
  <div class="page-404">
    <div class="page-404-container">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">{{ $t("page.404.error") }}</div>
        <div class="bullshit__headline">{{ $t("page.404.nofound") }}</div>
        <div class="bullshit__info">{{ $t("page.404.nofoundDesc") }}</div>
        <router-link to="/" class="bullshit__return-home">{{ $t("page.404.backHome") }}</router-link>
      </div>
    </div>
  </div>
</template>
